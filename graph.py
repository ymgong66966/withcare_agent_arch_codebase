...
async def downstream_catcher(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not nxt:
        ...
        if last_assistant:
            ...
            if is_limitation:
                # Route to human_comm — it will generate a follow-up proposal.
                # Do NOT return messages here — merge_utils appends, not replaces,
                # so returning the full list would duplicate every message.
                return {
                    "routing": {
